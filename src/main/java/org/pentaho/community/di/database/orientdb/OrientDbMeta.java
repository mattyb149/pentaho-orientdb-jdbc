 ...
 * 2) Update src/main/resources/pentaho-orientdb-jdbc-feature.xml and the POM as desired.
 * 3) For any class, add custom logic to workaround any limitations the real JDBC driver might have.
 */
@DatabaseMetaPlugin( type = "OrientDbMeta", typeDescription = "OrientDbMeta" )
public class OrientDbMeta extends BaseDatabaseMeta implements DatabaseInterface {

  public static final String SCHEME = "orient";
